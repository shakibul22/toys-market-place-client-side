...
<div className="w-full max-w-sm p-2 bg-white border  border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="px-5 pb-5">
        <a href="#">
            <h5 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">{name}</h5>
        </a>
        <a href="#">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Quantity: {quantity}</h5>
        </a>
        ...
        <div className="flex items-center justify-between">
            ...
            <button onClick={()=>handleNavigation(_id)} className='btn btn-info'>View Details</button>
